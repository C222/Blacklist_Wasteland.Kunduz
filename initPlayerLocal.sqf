...
_hint = parseText format ["<t align='center'><img size='5' image='images\blacklist_icon.paa'/></t><br/><t align='center' color='#FFFFFF' size='1.25'>Blacklist Wasteland</t><br/><br/><t align='left' color='#FFFFFF'>Bind User Action 1 for the Player Menu.</t><br/><br/><t align='left' size='0.75' color='#FFFFFF'>Please report bugs at<br/>https://github.com/C222/Blacklist_Wasteland.Kunduz/issues</t><br/><br/><t align='center' size='0.75' color='#FFFFFF'>Version %1</t>", getText (missionConfigFile >> "version")];
hint _hint;
