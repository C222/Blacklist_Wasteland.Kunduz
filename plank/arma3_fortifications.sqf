...
//--------------------------------------------------------------------------------------------------------------------------------------
["Small bunker",                        "Land_BagBunker_Small_F",               6,              180,                360,            {[_this select 1, 0] call plank_fnc_makePickupable;}],
["Bunker",                              "Land_BagBunker_Large_F",               8.5,            180,                60,             {[_this select 1, 1] call plank_fnc_makePickupable;}],
["Wide Sandbag fence",                  "Land_BagFence_Long_F",                 4,              0,                  360,            {[_this select 1, 2] call plank_fnc_makePickupable;}],
["H-Barrier watch tower",               "Land_HBarrierTower_F",                 15,             0,                  360,            {[_this select 1, 3] call plank_fnc_makePickupable;}],
["Short Sandbag fence",                 "Land_BagFence_Short_F",                3,              0,                  360,            {[_this select 1, 4] call plank_fnc_makePickupable;}],
["Razor Wire",                          "Land_Razorwire_F",                     6,              0,                  360,            {[_this select 1, 5] call plank_fnc_makePickupable;}],
["Concrete wall long",                  "Land_CncWall4_F",                      8,              0,                  360,            {[_this select 1, 6] call plank_fnc_makePickupable;}],
["Bunker Tower",                        "Land_BagBunker_Tower_F",               10,             0,                  360,            {[_this select 1, 7] call plank_fnc_makePickupable;}]
